...
class ReactionRoutes {
  ...
  public routes(): Router {
    this.router.get('/post/reactions/:postId', authMiddleware.checkAuthentication, Get.prototype.reaction);
    ...
    this.router.delete('/post/reaction/:postId/:previousReactions/:postReactions', authMiddleware.checkAuthentication, Remove.prototype.reaction);
