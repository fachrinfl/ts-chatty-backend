...
import { commentNames, commentNamesEmpty, commentsData, reactionMockRequest, reactionMockResponse } from '@root/mocks/reactions.mock';
...
describe('Get', () => {
  ...
  describe('commentsNamesFromCache', () => {
    ...
    it('should return empty comments if data does not exist in redis and database', async () => {
      ...
      const res: Response = reactionMockResponse();
      jest.spyOn(CommentCache.prototype, 'getCommentsNamesFromCache').mockResolvedValue([commentNamesEmpty]);
