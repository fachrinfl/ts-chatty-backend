...
export type PostCacheMutliType = string | number | Buffer | RedisCommandRawReply[] | IPostDocument | IPostDocument[];
...
export class PostCache extends BaseCache {
  ...
  public async getPostsFromCache(key: string, start: number, end: number): Promise<IPostDocument[]> {
    try {
      ...
      const replies: PostCacheMutliType = await multi.exec() as PostCacheMutliType;
  ...
  public async updatePostInCache(key: string, updatedPost: IPostDocument): Promise<IPostDocument> {
    ...
    try {
      ...
      const reply: PostCacheMutliType = await multi.exec() as PostCacheMutliType;
